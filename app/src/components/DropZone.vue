...
<template>
    <div class="box" @dragover.prevent="dragging(1)" @dragleave.prevent="dragging(0)" @drop.prevent="fileDropped"
        ...
        <div class="level">
            <div class="level-left">
                <div class="level-item">
                    <div class="file has-name">
                        <label class="file-label">
                            <input class="file-input" type="file" name="file" @change.prevent="fileSelected" />
                            <span class="file-cta">
                                <span class="file-icon">
                                    <svg viewBox="0 0 24 24" width="24" height="24" style="fill: black">
                                        <use href="#upload" />
                                    </svg>
                                </span>
                ...
                <div class="level-item">
                    <button @click="fileUpload" class="button is-primary" :disabled="buttonDisabled">
                        アップロード
                    </button>
                </div>
            </div>
